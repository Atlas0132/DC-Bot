...
let validRoles = {    // Make sure this matches the emojis/IDs used in add.js
  '🎭': '889003121936834611',
  '🎮': '889002573296697354', 
...
if (context.params.event.message_id === validMessage && validRole) { // This will check the role, then remove it from the user.
